...
//
//  def buildChRISSubmission(claimId: String): Future[Either[String, GovTalkMessage]]
//
//}
//
//  @Singleton
//  class ChRISSubmissionServiceImpl @Inject()(claimsService: ClaimsService)(using ExecutionContext) extends ChRISSubmissionService {
//    def buildChRISSubmission(claimId: String): Future[Either[String, GovTalkMessage]] =
//      claimsService.getClaim(claimId).flatMap {
...
//            )
//          )
//          Future.successful(Right(govTalkMessage))
//
//        case None =>
//          Future.successful(Left("CLAIM_NOT_FOUND"))
//
//      }
//
//
