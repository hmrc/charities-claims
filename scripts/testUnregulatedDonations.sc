...
// - formp-proxy microservice is running on port 6995
...
def saveUnregulatedDonationRequest(charityReference: String, claimId: Int, amount: BigDecimal)(using authorization: Authorization) = 
  ...
  .post(uri"http://localhost:6995/formp-proxy/charities/$charityReference/unregulated-donations")
